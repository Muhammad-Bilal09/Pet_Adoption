...
const AddPetForm = () => {
  ...
  const petTypes = [{ label: 'Dogs', value: 'dogs' }, { label: 'Cats', value: 'cats' },{ label: 'Bunnies', value: 'Bunnies' },{ label: 'Birds', value: 'Birds' },{ label: 'Turtles', value: 'Turtles' }];
  ...
  const handleSubmit = async () => {
    if (!petName||!petAge ||!petType || !petBreed || !amount || !location || !description || !imageUri) {
...
//       description,
//       imageUri,
//       createdAt: firestore.FieldValue.serverTimestamp(), // optional: store creation timestamp
//     };
